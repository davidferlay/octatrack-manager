...
| AP133 | Pool Page | Browse/Import gated to Files tab | On the Audio Pool page, switch to the Tools tab | The Browse and Import header buttons are disabled; switching back to Files re-enables them |
