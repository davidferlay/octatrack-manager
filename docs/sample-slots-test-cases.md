...
| AP120 | Usage | Factory defaults not counted | Open a fresh project (default static slot N on track N everywhere, no trigs) | Every slot shows a dash in the Used column: untrigged factory-default machine assignments are not reported as references |
