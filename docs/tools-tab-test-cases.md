...
| PRG-37 | Purge Project / Audio Pool Samples | Confirmation reflects the chosen action | Complete a purge once in Move mode and once in Delete mode | Move reads "... moved to <destination folder> - <size> reclaimed."; Delete reads "... sent to the Trash Bin - <size> reclaimed." |
