...
- **Automatic Backup:** The app automatically backs up the destination bank file(s) before executing. See [Quick Start](../getting-started/quick-start.md#10-automatic-backups) for details.
